...
You can leverage the app simpleloanvalidationsparkrunner from [the ODM-on-Spark repositor](https://github.com/ODMDev/decisions-on-spark/blob/master/simple-loan-validation-spark-runner/README.md).
